...
function DelphiTextLogo(props: React.ComponentProps<typeof SvgIcon>) {
  const classes = useStyles();
  const theme = useTheme();

  return (
    <SvgIcon {...props} classes={classes} viewBox="0 0 130 21">
      <defs>{theme.gradients.landingText.svgLinear('delphiTextLogoGradient')}</defs>
      <g fill="none" fillRule="evenodd" transform="translate(-243 -192)">
        <path
          fill="url(#delphiTextLogoGradient)"
