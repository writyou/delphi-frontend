...
const subgraphHttpUrlsByMode: Record<Mode, string> = {
  testnet:
    "https://api.thegraph.com/subgraphs/name/in19farkt/akropolis-os-rinkeby",
  sandbox:
    "https://api.thegraph.com/subgraphs/name/in19farkt/akropolis-os-sandbox",
  mainnet:
    "https://api.thegraph.com/subgraphs/name/in19farkt/akropolis-os-mainnet",
};

const subgraphWsUrlsByMode: Record<Mode, string> = {
  testnet:
    "wss://api.thegraph.com/subgraphs/name/in19farkt/akropolis-os-rinkeby",
  sandbox:
    "wss://api.thegraph.com/subgraphs/name/in19farkt/akropolis-os-sandbox",
  mainnet:
    "wss://api.thegraph.com/subgraphs/name/in19farkt/akropolis-os-mainnet",
};
