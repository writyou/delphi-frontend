...
function Cat1(props: React.ComponentProps<typeof SvgIcon>) {
  return (
    <SvgIcon {...props} viewBox="0 0 52 52">
      <defs>
        <linearGradient id="Cat1-gradient-b" x1="50%" x2="50%" y1="100%" y2="0%">
          <stop offset="0%" stopColor="#F868E0" />
          <stop offset="100%" stopColor="#FC8BE2" />
        </linearGradient>
        <linearGradient id="Cat1-gradient-d" x1="50%" x2="50%" y1="27.49%" y2="100%">
          <stop offset="0%" stopColor="#494972" />
          <stop offset="100%" stopColor="#0A0A0E" />
        </linearGradient>
        <circle id="Cat1-circle-a" cx="26" cy="26" r="26" />
      </defs>
