...
export function getSdk(client: GraphQLClient, withWrapper: SdkFunctionWrapper = defaultWrapper) {
  return {
    ...
    DebtsAvailableForLiquidation(variables: DebtsAvailableForLiquidationQueryVariables): Promise<DebtsAvailableForLiquidationQuery> {
      return withWrapper(() => client.request<DebtsAvailableForLiquidationQuery>(print(DebtsAvailableForLiquidationDocument), variables));
    },
    DefiAprsFromDate(variables: DefiAprsFromDateSubscriptionVariables): Promise<DefiAprsFromDateSubscription> {
      return withWrapper(() => client.request<DefiAprsFromDateSubscription>(print(DefiAprsFromDateDocument), variables));
    },
    DistributionClaimsByEvent(variables: DistributionClaimsByEventQueryVariables): Promise<DistributionClaimsByEventQuery> {
      return withWrapper(() => client.request<DistributionClaimsByEventQuery>(print(DistributionClaimsByEventDocument), variables));
    },
    DistributionEvents(variables: DistributionEventsQueryVariables): Promise<DistributionEventsQuery> {
      return withWrapper(() => client.request<DistributionEventsQuery>(print(DistributionEventsDocument), variables));
    },
    MyBalanceChanges(variables: MyBalanceChangesQueryVariables): Promise<MyBalanceChangesQuery> {
      return withWrapper(() => client.request<MyBalanceChangesQuery>(print(MyBalanceChangesDocument), variables));
    },
    MyEarnings(variables: MyEarningsQueryVariables): Promise<MyEarningsQuery> {
      return withWrapper(() => client.request<MyEarningsQuery>(print(MyEarningsDocument), variables));
    },
    MyGuarantees(variables: MyGuaranteesQueryVariables): Promise<MyGuaranteesQuery> {
      return withWrapper(() => client.request<MyGuaranteesQuery>(print(MyGuaranteesDocument), variables));
    },
    MyLoans(variables: MyLoansQueryVariables): Promise<MyLoansQuery> {
      return withWrapper(() => client.request<MyLoansQuery>(print(MyLoansDocument), variables));
    },
    MyUser(variables: MyUserSubscriptionVariables): Promise<MyUserSubscription> {
      return withWrapper(() => client.request<MyUserSubscription>(print(MyUserDocument), variables));
    },
    MyUserBalances(variables: MyUserBalancesSubscriptionVariables): Promise<MyUserBalancesSubscription> {
      return withWrapper(() => client.request<MyUserBalancesSubscription>(print(MyUserBalancesDocument), variables));
    },
    Pledge(variables: PledgeSubscriptionVariables): Promise<PledgeSubscription> {
      return withWrapper(() => client.request<PledgeSubscription>(print(PledgeDocument), variables));
    },
    PoolBalances(variables: PoolBalancesSubscriptionVariables): Promise<PoolBalancesSubscription> {
      return withWrapper(() => client.request<PoolBalancesSubscription>(print(PoolBalancesDocument), variables));
    },
    PoolMetricByDate(variables: PoolMetricByDateSubscriptionVariables): Promise<PoolMetricByDateSubscription> {
      return withWrapper(() => client.request<PoolMetricByDateSubscription>(print(PoolMetricByDateDocument), variables));
    },
    PoolMetrics(variables?: PoolMetricsSubscriptionVariables): Promise<PoolMetricsSubscription> {
      return withWrapper(() => client.request<PoolMetricsSubscription>(print(PoolMetricsDocument), variables));
    }
  };
}
